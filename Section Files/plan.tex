...
After the creation of each section we will test the generated pdf using Blackboard Allie or Acrobat Accessibility Check.  And use one or more programs to convert the file to HTML. 
